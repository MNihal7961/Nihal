...
import {
    ...
    Sun,
    Laptop,
    // Code, // only used by the temporarily-disabled Projects entry
    Sparkles,
    ArrowUp,
    ArrowDown,
    CornerDownLeft,
    ...
    React.useEffect(() => {
        const down = (e: KeyboardEvent) => {
            ...
            if (e.shiftKey) {
                ...
                // Projects temporarily disabled — re-enable when ready:
                // } else if (key === 'p') {
                //     e.preventDefault()
                //     runCommand(() => router.push("/projects"))
                } else if (key === 'k') {
                    e.preventDefault()
                    runCommand(() => router.push("/skills"))
                } else if (key === 'r') {
                    e.preventDefault()
                ...
                // Links
                    ...
                    e.preventDefault()
                    runCommand(() => openExternal(SOCIAL_LINKS.linkedin))
                } else if (key === 'g') {
                    e.preventDefault()
                    runCommand(() => openExternal(SOCIAL_LINKS.github))
                } else if (key === 'e') {
                    e.preventDefault()
            ...
            <CommandDialog open={open} onOpenChange={setOpen} className="font-custom2">
                ...
                <CommandList className="font-custom2 p-2">
                    ...
                    <CommandGroup heading="Navigation">
                        ...
                        */}
                        <CommandItem onSelect={() => runCommand(() => router.push("/skills"))} className="rounded-lg py-3">
                            <Sparkles className="mr-2 h-4 w-4 text-neutral-500" />
                            <span>Go to Skills</span>
                            <CommandShortcut className="font-mono text-[10px] bg-neutral-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded border border-neutral-200 dark:border-neutral-700">shift + K</CommandShortcut>
                        </CommandItem>
                    ...
                    <CommandGroup heading="Links">
                        <CommandItem onSelect={() => runCommand(() => openExternal(SOCIAL_LINKS.linkedin))} className="rounded-lg py-3">
                        ...
                        <CommandItem onSelect={() => runCommand(() => openExternal(SOCIAL_LINKS.github))} className="rounded-lg py-3">
