...
const Navbar = () => {
  const navItems = [
    // Temporarily disabled — re-enable when the Projects page is ready.
    ...
    <Container>
      ...
      >
        <Link href="/" className="hover:opacity-75 transition-opacity duration-300">
          <span className="flex w-9 h-9 items-center justify-center rounded-full bg-neutral-900 dark:bg-neutral-100 text-neutral-50 dark:text-neutral-900 text-xs font-semibold shadow-sm">
            NM
          </span>
        </Link>
